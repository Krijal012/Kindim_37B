            ...
            >
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-800 mb-1 text-sm sm:text-base">{review.productName}</h3>
                  ...
                  {review.title && (
                    <h4 className="font-semibold text-gray-700 mb-1 text-sm sm:text-base">{review.title}</h4>
                  )}
                  ...
                  {review.sellerResponse && (
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-600">
                      <p className="text-xs sm:text-sm font-semibold text-gray-700">Seller Response:</p>
                      <p className="text-xs sm:text-sm text-gray-600 mt-1">{review.sellerResponse}</p>
                    </div>
                  )}
                </div>
              </div>
