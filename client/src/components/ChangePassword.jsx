...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await callApi("POST", "/change-password", {
  ...
  return (
    <div className="flex-1 bg-white p-4 sm:p-6 rounded-lg shadow max-w-full sm:max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full py-2 sm:py-3 rounded-lg text-white font-semibold text-sm sm:text-base ${loading ? "bg-gray-400" : "bg-blue-600 hover:bg-blue-700"}`}
        >
