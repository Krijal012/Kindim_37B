...
function BargainPage() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen bg-gray-50 pt-16 sm:pt-24 pb-10 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-4 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-center mb-2">Request a Lower Price</h1>
          <p className="text-center text-gray-600 text-sm sm:text-base mb-6 px-2">
